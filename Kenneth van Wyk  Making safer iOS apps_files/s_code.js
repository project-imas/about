...
/************************ ADDITIONAL FEATURES ************************
     ...
     Plugins
*/
//var s_account="idgcomputerworldhprod";	// dev account
var s_account="computerworldcom"
...
s.linkInternalFilters="javascript:ww.computerworld.com,reg.accelacomm.com";  
...
function s_doPlugins(s) {
	/* Add calls to plugins here */
		...
		/* Referrer */
		if (document.referrer.indexOf('http://www.computerworld.com') != 0 &&
			document.referrer.indexOf('http://computerworld.com') != 0) {
		...
		s.prop48=s.getPreviousValue(s.pageName,"s_pv");
		if (s.prop48){
		...
		/* reserve evar 15 for twitter */
		for (i=0;i<40;i++) if(s['prop'+i]&&!s['eVar'+i]&&i!=15) s['eVar'+i]=s['prop'+i];
}
